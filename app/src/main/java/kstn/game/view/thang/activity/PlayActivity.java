...
import kstn.game.view.thang.fragment.ChoiThoiFragment;
import kstn.game.view.thang.fragment.DoanFragment;
import kstn.game.view.thang.fragment.LeterFragment;
...
public class PlayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionManagerDAO = new QuestionManagerDAO(PlayActivity.this);
        questionManagerDAO.open();
        data = questionManagerDAO.getData();
